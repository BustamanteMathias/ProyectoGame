...
namespace ProyectoGame
{
    public class NPC_Voz : NPC
    {
        ...
        public NPC_Voz(int id, string nombre, string descripcion, float vida, int nivel, double experiencia, float aFisico, float aMagico, float dFisica, float dMagica) : base(id, nombre, descripcion, vida, nivel, experiencia, aFisico, aMagico, dFisica, dMagica)
        {
            this.CARTA_1 = null;
            this.CARTA_2 = null;
            this.CARTA_3 = null;
            this.clase = EClase.Voz;
        }

        public static NPC_Voz operator +(NPC_Voz NPC, Carta c)  //EQUIPAR
        {

            if (c.Clase == EClase.Voz)
            {
                if (NPC.CARTA_1 == null)
                {
                    NPC.CARTA_1 = c;
        ...
        public static NPC_Voz operator -(NPC_Voz NPC, int SLOT) //DESEQUIPAR
        {
            switch (SLOT)
            {
                case 1:
