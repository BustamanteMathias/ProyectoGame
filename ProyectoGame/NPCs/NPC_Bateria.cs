...
namespace ProyectoGame
{
    public class NPC_Bateria : NPC
    {
        ...
        public NPC_Bateria(int id, string nombre, string descripcion, float vida, int nivel, double experiencia, float aFisico, float aMagico, float dFisica, float dMagica) : base(id, nombre, descripcion, vida, nivel, experiencia, aFisico, aMagico, dFisica, dMagica)
        {
            this.CARTA_1 = null;
            this.CARTA_2 = null;
            this.CARTA_3 = null;
        ...
        public static NPC_Bateria operator +(NPC_Bateria NPC, Carta c)
        {

            if (c.Clase == EClase.Bateria)
            {
                if (NPC.CARTA_1 == null)
                {
                    NPC.CARTA_1 = c;
        ...
        public static NPC_Bateria operator -(NPC_Bateria NPC, int SLOT)
        {
            switch (SLOT)
            {
                case 1:
