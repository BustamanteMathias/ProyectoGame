...
namespace ProyectoGame
{
    public class NPC_Guitarra : NPC
    {
        ...
        public NPC_Guitarra(int id, string nombre, string descripcion, float vida, int nivel, double experiencia, float aFisico, float aMagico, float dFisica, float dMagica) : base (id, nombre, descripcion, vida, nivel, experiencia, aFisico, aMagico, dFisica, dMagica)
        {
            this.CARTA_1 = null;
            this.CARTA_2 = null;
            this.CARTA_3 = null;
            this.clase = EClase.Bateria;
        }

        public static NPC_Guitarra operator +(NPC_Guitarra NPC, Carta c)
        {

            if (c.Clase == EClase.Guitarra)
            {
                if (NPC.CARTA_1 == null)
                {
                    NPC.CARTA_1 = c;
                    ...
                    Console.WriteLine("Se agrego carta en SLOT: 1");
                }
                else if (NPC.CARTA_2 == null)
                {
                    ...
                    NPC.DefensaFisica += c.DefensaFisica;
                    NPC.DefensaMagica += c.DefensaMagica;
                    Console.WriteLine("Se agrego carta en SLOT: 2");
                }
                else if (NPC.CARTA_3 == null)
                {
                    ...
                    NPC.DefensaFisica += c.DefensaFisica;
                    NPC.DefensaMagica += c.DefensaMagica;
                    Console.WriteLine("Se agrego carta en SLOT: 3");
                }
                else
                {
        ...
        public static NPC_Guitarra operator -(NPC_Guitarra NPC, int SLOT)
        {
            switch (SLOT)
            {
                case 1:
